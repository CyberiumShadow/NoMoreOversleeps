...
public class IntegrationPavlok extends Integration
{
	...
	public void led(long amount, String reason) throws Exception
	{
		...
		Communicator.basicJsonMessage("led", "http://pavlok-mvp.herokuapp.com/api/v1/stimuli/led/" + amount, new Stimuli(amount, NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token, reason), String.class, false, "Bearer " + NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token);
	}

	public void beep(long amount, String reason) throws Exception
	{
		log.info("Sending: beep " + amount + " (" + reason + ")");
		Communicator.basicJsonMessage("beep", "http://pavlok-mvp.herokuapp.com/api/v1/stimuli/beep/" + amount, new Stimuli(amount, NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token, reason), String.class, false, "Bearer " + NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token);
	}

	public void vibration(long amount, String reason) throws Exception
	{
		log.info("Sending: vibration " + amount + " (" + reason + ")");
		Communicator.basicJsonMessage("vibration", "http://pavlok-mvp.herokuapp.com/api/v1/stimuli/vibration/" + amount, new Stimuli(amount, NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token, reason), String.class, false, "Bearer " + NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token);
	}

	public void shock(long amount, String reason) throws Exception
	{
		log.info("Sending: shock " + amount + " (" + reason + ")");
		Communicator.basicJsonMessage("shock", "http://pavlok-mvp.herokuapp.com/api/v1/stimuli/shock/" + amount, new Stimuli(amount, NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token, reason), String.class, false, "Bearer " + NMOConfiguration.INSTANCE.integrations.pavlok.auth.access_token);
	}
}
